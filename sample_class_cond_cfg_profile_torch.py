...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        with profile (
            ...
            profile_memory=True,
            with_stack=True,
            on_trace_ready=torch.profiler.tensorboard_trace_handler(f'./log/inference')
        ) as prof:
            ...
            for cfg_scale in [3.5]:
                ...
                for seed in [args.seed]:
                    ...
                    for i in tqdm(range(2)):
                        ...
                        with record_function("model sample"):
                        ...
                        for j in range(sampled_array.shape[0]):
                            ...
                            with record_function("ae decode"):
                                outputs_dict = ae.decode(sampled_array[j : j + 1], queries_grid)
                            

                            with record_function("gs model"):
                            ...
                            with record_function("gs render"):
