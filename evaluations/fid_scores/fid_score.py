...
def compute_statistics_of_path(path, model, batch_size, dims, device,
    ...
    basepath=f'./objaverse-results/gt/fid{reso}'
...
def compute_statistics_of_path_pred(path, model, batch_size, dims, device,
                               num_workers=1,reso=128,dataset='omni',basepath=None):
    print(f"path={path}")
...
def calculate_fid_given_paths(paths, batch_size, device, dims, num_workers=1,reso=128,dataset='omni',basepath=None):
    ...
    m2, s2 = compute_statistics_of_path_pred(paths[1], model, batch_size, # ! generated data
                                        dims, device, num_workers,reso=reso,dataset=dataset,basepath=basepath)
...
def main():
    ...
    fid_value = calculate_fid_given_paths(args.path,
                                          ...
                                          device,
                                          args.dims,
                                          num_workers,args.reso,args.dataset,args.basepath)
    print('FID: ', fid_value)
